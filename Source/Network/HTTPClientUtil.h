 ...
 * @see async_context
 */
int HTTPClientRequestAsync(struct async_context *context, HTTPRequest_t *req);
 ...
 */
int HTTPClientRequestSync(struct async_context *context, HTTPRequest_t *req);
 ...
 */
err_t HTTPClientHeaderPrintFN(httpc_state_t *connection, void *arg, struct pbuf *hdr, u16_t hdr_len, u32_t content_len);
 ...
 * @return if != zero is returned, the connection is aborted
 */
err_t HTTPClientReceivePrintFN(void *arg, struct altcp_pcb *conn, struct pbuf *p, err_t err);
